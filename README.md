...
![Scikit-Learn](https://img.shields.io/badge/Scikit--Learn-Machine_Learning-yellow.svg)
...
## 📊 Dataset Details
The dataset (`loan_data.csv`) contains **45,000 records** and **14 features**, categorized into:
...
3. **⚖️ Feature Scaling:** Applied `StandardScaler` to ensure large numerical values (like Income) do not disproportionately bias the model over smaller percentages (like Interest Rate).
